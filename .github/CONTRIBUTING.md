### Hello, and thank you for contributing to the CreateWaySMP !
...
### Requirements
There are some specific requirements you need to follow when making and proposing changes to CreateWay Modpack. This ensures order, consistency, and organization.  
...
1. Fork the repository ([fork](https://github.com/Peperehobbit01/the-smp-issue-tracker/fork));
